//variable
var urlServer='http://localhost/utt/door2door/server/';
var urlMedia='http://localhost/utt/door2door/server/img/';
...
function showInfo(data)
{
	...
	doorcodeNumber.innerHTML = '6565'; //--------------TO PLACE API!!! ---------
	...
	housenumNum.innerHTML = '45';  //--------------TO PLACE API!!! ---------
...
function showSpendReportPage(data)
{
	...
	var cmb = document.createElement('option');
	cmb.innerHTML = '--Select a Option--';
	cmbPeriods.appendChild(cmb);
